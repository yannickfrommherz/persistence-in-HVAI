...
- `environment.yml` can be used to recreate a `conda` environment relying on Python 13.3 and all needed packages in the correct version. Run `conda env create -f environment.yml` in your command line.
